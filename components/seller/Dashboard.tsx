            ...
            <main className="container mx-auto px-4 py-8">
                ...
                <div className="flex gap-2 mb-8 border-b border-gray-200">
                    <button
                        ...
                        className={`px-4 py-2.5 text-sm font-medium border-b-2 transition-colors ${activeTab === "products"
                    ...
                    <button
                        ...
                        className={`px-4 py-2.5 text-sm font-medium border-b-2 transition-colors ${activeTab === "blog"
                            ? "border-brand-maroon text-brand-maroon"
                            : "border-transparent text-gray-500 hover:text-brand-black"
                            }`}
                    >
