...
export default function Footer() {
    return (
        <footer className="bg-brand-maroon-deep text-brand-cream">
            <div className="interlock-divider w-full text-brand-gold-bright/30"></div>
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 divide-y divide-white/10 md:divide-y-0">
                    ...
                    <div className="space-y-4 md:space-y-6 pb-8 md:pb-0">
                        <h2 className="sr-only">{siteContent.brandName}</h2>
                        ...
                        <div className="flex -ml-2 pt-2">
                            <a href={siteContent.socials.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="p-2.5 hover:text-brand-gold-bright transition-colors">
                                <Instagram size={20} />
                            </a>
                            <a href={siteContent.socials.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="p-2.5 hover:text-brand-gold-bright transition-colors">
                                <Facebook size={20} />
                            </a>
                            <a href={siteContent.socials.youtube} target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="p-2.5 hover:text-brand-gold-bright transition-colors">
                                <Youtube size={20} />
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4 md:space-y-6 py-8 md:py-0">
                        <h3 className="font-serif text-lg text-brand-gold-bright tracking-widest uppercase">Explore</h3>
                    ...
                    {/* Contact Details */}
                    <div className="space-y-4 md:space-y-6 py-8 md:py-0">
                        <h3 className="font-serif text-lg text-brand-gold-bright tracking-widest uppercase">Contact</h3>
                        <ul className="space-y-4 text-sm text-brand-cream/65">
                            <li className="flex items-start gap-3">
                                <MapPin size={18} className="mt-1 text-brand-gold-bright shrink-0" />
                            ...
                            <li className="flex items-start gap-3">
                                <Mail size={18} className="mt-0.5 text-brand-gold-bright shrink-0" />
                                <a href={`mailto:${siteContent.contact.email}`} className="min-w-0 hover:text-white transition-colors">
                                    {/* wrap at the @ only, never mid-word */}
                                    {(() => {
                                        const [local, domain] = siteContent.contact.email.split("@");
                                        return <>{local}<wbr />@{domain}</>;
                                    })()}
                                </a>
                            </li>
                        </ul>
                    ...
                    <div className="space-y-4 md:space-y-6 pt-8 md:pt-0">
                        <h3 className="font-serif text-lg text-brand-gold-bright tracking-widest uppercase">Legal</h3>
                        <ul className="space-y-3 text-sm text-brand-cream/65">
                        ...
                        <p className="text-xs text-brand-cream/45 pt-4 md:pt-8">
